...
if __name__ == "__main__":
    ...
    for z in range(len(content_list)):
        for zz in range(len(style_list)):
            ...
            try:
                ...
                style_path   = style_list[zz]     # './examples/style/tar11.png'
            ...
            for i in prog_bar:
                ...
                if (i + 1) % args.sample_freq == 0 or i == 0 or i == args.iter-1:
                    ...
                    c_name = c_img.split('.' + args.fileType)[0] # in11
                    s_name = s_img.split('.' + args.fileType)[0] # tar11
                    ...
                    root_iter_path = os.path.join(os.path.join(args.save_root, c_name), pair_dir)
                    ...
                    if i == args.iter - 1:
                        cv2.imwrite( os.path.join(root_iter_path, c_name + '_' +  s_name + '_' + 'result_bundle.png'), bundle_result)
                        cv2.imwrite( os.path.join(os.path.join(args.save_root, c_name), c_name + '_' +  s_name + '_' + 'result_bundle.png'), bundle_result)
